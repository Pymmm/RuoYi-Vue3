...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除组织管理编号为"' + _ids + '"的数据项？').then(function () {
...
/* 新增：上传地址 */
const uploadExcelUrl = ref(import.meta.env.VITE_APP_BASE_API + "/mdm/organization/import");// 上传Excel文件地址
/* 新增：上传请求头 */
